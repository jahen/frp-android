...
public abstract class FrpcDatabase extends RoomDatabase {
    private static volatile FrpcDatabase instance;

    public abstract ConfigDao configDao();

    public static FrpcDatabase getInstance(Context context) {
        if (instance == null) {
            synchronized (FrpcDatabase.class) {
                if (instance == null) {
                    instance = Room.databaseBuilder(context,
                            FrpcDatabase.class, "frpc_android.db")
